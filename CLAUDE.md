...
Earthquakes is a small webapp that fetches earthquake data and displays it in a time-series fashion on a leaflet map.

Controls: Speed, refresh data, zoom, layer. Configuration: how far back to fetch, how long to cache. 

## Libraries
Use: Eel for the UI, LeafletJS. 
...
- **Always refer to the documentation for library APIs**
